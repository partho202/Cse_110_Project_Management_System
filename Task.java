...
import javax.swing.table.DefaultTableModel;
 ...
 class TaskInfo {
    ...
    TaskInfo(String id, String to_do, String status, String assigned) {
        this.id = id;
        this.to_do = to_do;
        this.status = status;
...
public class Task extends JFrame{
    public Task() throws FileNotFoundException {
        ...
        JLabel empolyeesearch = new JLabel("Tasks Information");
       ...
       JButton viewTeamLeaders = new JButton("View Team Leaders");
        ...
        addTask.setBounds(1200, 250, 150,30);
        addTask.setFont(new Font("Arial", Font.BOLD, 18));
        frame.add(addTask);
        ...
        refresh.setBounds(1200, 400, 150,30);
        refresh.setFont(new Font("Arial", Font.BOLD, 18));
        frame.add(refresh);
